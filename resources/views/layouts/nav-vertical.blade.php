        ...
        <div class="container"><a class="navbar-brand" href="{{ route('Home') }}"><span class="text-white dark__text-white">GPLANILLA</span></a>
          ...
          <div class="collapse navbar-collapse scrollbar" id="navbarStandard">
            <ul class="navbar-nav" data-top-nav-dropdowns="data-top-nav-dropdowns">
               <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="apps">Dashboard</a>
                      ...
                      <div class="row">
                        <div class="col-6 col-md-5">
                          <div class="nav flex-column">
                            <a class="nav-link py-1 link-600 fw-medium" href="{{ route('Home') }}">Home</a>
                            <a class="nav-link py-1 link-600 fw-medium" href="{{ route('Employee') }}">Tipos Contratos</a>
                            <a class="nav-link py-1 link-600 fw-medium" href="{{ route('Employee') }}">Unidad de Negocio</a>
                            <p class="nav-link text-700 mb-0 fw-bold">Colaboradores</p>
                            <a class="nav-link py-1 link-600 fw-medium" href="{{ route('Employee') }}">Lista</a>
                            <a class="nav-link py-1 link-600 fw-medium" href="{{ route('AddEmployee') }}">Agregar</a>
                            <p class="nav-link text-700 mb-0 fw-bold">Solcitudes</p>
                            <a class="nav-link py-1 link-600 fw-medium" href="../app/events/create-an-event.html">Crear</a>
                            <a class="nav-link py-1 link-600 fw-medium" href="../app/events/event-detail.html">Tipos</a>
                            <a class="nav-link py-1 link-600 fw-medium" href="../app/events/event-list.html">Estados</a>
                        ...
                        <div class="col-6 col-md-4">
                          <div class="nav flex-column">
                            <p class="nav-link text-700 mb-0 fw-bold">Catalogos</p>
                            <a class="nav-link py-1 link-600 fw-medium" href="../app/e-commerce/product/product-list.html">Contratos</a>
                            <a class="nav-link py-1 link-600 fw-medium" href="../app/e-commerce/product/product-grid.html">Unidad de Negocio</a>
                            <a class="nav-link py-1 link-600 fw-medium" href="../app/e-commerce/product/product-details.html">Departamentos</a>
                            <a class="nav-link py-1 link-600 fw-medium" href="../app/e-commerce/orders/order-list.html">Posiciones</a>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <!-- <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="pagess">Dashboard</a>
                    ...
                    <div class="card-body scrollbar max-h-dropdown"><img class="img-dropdown" src="../assets/img/icons/spot-illustrations/authentication-corner.png" width="130" alt="" />
                      <div class="row">
                        <div class="col-6 col-xxl-3">
                          <div class="nav flex-column">
                            <p class="nav-link text-700 mb-0 fw-bold">Home</p>
